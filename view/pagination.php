...
<body>
	...
	<?php
		...
		$sql 	= $db->getRecFrmQry("SELECT * FROM pageusers WHERE 1 ".$condition."");
		$pages->items_total	=	count($sql);
		$pages->mid_range	=	9;
		$pages->paginate(); 
		 
		$userData	=   $db->getRecFrmQry("SELECT * FROM pageusers WHERE 1 ".$condition." ORDER BY id DESC ".$pages->limit."");
