...
// session_start();
    ...
    if(isset($_REQUEST['attachid']) and $_REQUEST['attachid']!=""){
        $row	=	$db->getAllRecords('cwo_support_docs','*',' AND attach_id="'.$_REQUEST['attachid'].'"'); 
...
//     }
    ...
    echo $emp1[0]; //red 
    echo $uploadedrname = $emp1[1]." ".$emp[2]; 
    ...
    $data	=	array(
        ...
        $update	=	$db->update('cwo_support_docs',$data,array('attach_id'=> $attachid));
        $errors= array();
        ...
        $extensions= array("pdf","jpeg","jpg","png","pdf","doc", "xls");
                        ...
                        <div class="card">
                            ...
                            <?php require_once('../common/message.php');  ?>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="d-flex w-100 justify-content-start">
                                                ...
                                                <span class="pl-5 ft-s-16 ft-w-600 ft-c-black">Complaint Work Order: <?php echo $row[0]['cwo_code']; ?></span>  
                                            </div>
                                            </div>
                                        </div>
                                            <div class="row">
                                                ...
                                                <select class="tel form-control"  name="sender_emp_code" 
                                        id="sender_emp_code">
                                        <option> <?php echo  $row[0]['sender_emp_code']." ".$row[0]['send_staff_name'];?> </option>
                                        <?php  foreach($employeeData as $val){ ?>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="doc_received_date" id="doc_received_date" value="<?php echo $row[0]['doc_received_date']; ?>"
                                    ...
                                    <select class="tel form-control"  name="uploded_emp_code" 
                                        id="uploded_emp_code">
                                        <option> <?php echo  $row[0]['uploded_emp_code']." ".$row[0]['uploded_staff_name'];?> </option>
                                        <?php  foreach($employeeData as $val){ ?>
                                                        <option>
                                                            <?php echo  $val['emp_code']." ". $val['emp_fname'] ." ". $val['emp_lname'];?>
                                                        </option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="doc_updated_date" id="doc_updated_date"  value="<?php echo $row[0]['doc_updated_date']; ?>"
                                                            class="form-control" placeholder="Enter date" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group"> <label>Remark</label>
                                                        <textarea class="form-control demoInputBox" id="attach_comments"
                                                            name="attach_comments" rows="3" required><?php echo $row[0]['attach_comments']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div id="preview"></div>
                                                    <input type="file" name="supportdocs" id="supportdocs"  class="mt-2" value="<?php echo $row[0]['emp_profile_img_name']; ?>">
                                                </div>
                                                </div>
                                        </div>
                                            </div>
