...
$dbcon = new dbconfig();
    ...
    class invoice_total extends dbconfig
    {
        function total_invoice()
        {
            ...
            $sqla ="select sum(invoicetot) AS totalinvoice FROM purchased_items_inventory where invoiceid = 'Debit'";
                $invoiceTt =	mysqli_query($dbcon->connection, $sqla);
